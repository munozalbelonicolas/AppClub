// =============================================================================
// NOTIFICACIONES PUSH VÍA CLOUD FUNCTIONS
// =============================================================================
// ⚠️  DESHABILITADO — Plan Spark (gratuito) de Firebase
//
// Las Cloud Functions no pueden realizar llamadas de red externas (FCM API)
// en el plan Spark. Para activar estas funciones, el proyecto debe estar
// en el plan Blaze (pago por uso).
//
// CÓMO ACTIVAR CUANDO SE SUBA AL PLAN BLAZE:
//   1. Cambiar el plan en Firebase Console → https://console.firebase.google.com
//   2. En functions/src/index.ts, descomentar: export * from './notifications';
//   3. Ejecutar: firebase deploy --only functions
//
// SISTEMA ACTUAL (gratuito, Spark):
//   Las notificaciones en tiempo real se manejan desde el cliente Flutter
//   mediante un Firestore listener en:
//   lib/core/services/notification_service.dart → startNotificationStream()
//   Funciona cuando la app está abierta o en segundo plano.
// =============================================================================
